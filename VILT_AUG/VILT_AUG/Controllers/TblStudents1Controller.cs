...
namespace VILT_AUG.Controllers
{
    ...
    [ApiController]
    public class TblStudents1Controller : ControllerBase
    {
        private readonly StudentDBContext _context;

        public TblStudents1Controller(StudentDBContext context)
        {
            _context = context;
        }

        // GET: api/TblStudents1
        [HttpGet]
