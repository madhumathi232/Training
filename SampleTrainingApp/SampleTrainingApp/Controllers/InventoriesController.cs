...
namespace SampleTrainingApp.Controllers
{
    public class InventoriesController : Controller
    {
        ...
        public InventoriesController(SampleTrainingAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Inventory != null ? 
                          ...
                          Problem("Entity set 'SampleTrainingAppContext.Inventory'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ProdId,ProdName,price")] Inventory inventory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdId,ProdName,price")] Inventory inventory)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!InventoryExists(inventory.ProdId))
                    {
                        return NotFound();
                    }
                    else
